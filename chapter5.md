...
| - | - | - |
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.|<p>**Fabio Horna TB01:**</p><p>Documenté todas las etapas del proyecto AgroMercado de forma clara y precisa, incluyendo análisis de usuarios, modelado de dominio, arquitectura de software, base de datos, diseño de interfaces y validaciones. Ajusté el nivel de detalle de los informes según el público objetivo, elaborando desde reportes técnicos hasta resúmenes ejecutivos accesibles para usuarios no especializados.</p>|Logré transmitir los resultados del proyecto con objetividad, adaptando el lenguaje y el nivel de tecnicismo de los documentos para que fueran comprensibles y útiles tanto para especialistas en ingeniería como para usuarios de perfil operativo o estratégico.|
|Comunica oralmente sus ideas y/o resultados con objetividad al público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.|<p>**Fabio Horna TB01:**</p><p>Expuse los avances y resultados de AgroMercado ante distintos públicos, utilizando presentaciones orales organizadas, lenguaje claro y ejemplos prácticos. Ajusté la profundidad de la explicación según el perfil de la audiencia (técnicos, gestores, usuarios finales), asegurando la comprensión del flujo de la plataforma, el impacto esperado y los beneficios para los usuarios rurales.</p>|Pude comunicar ideas y resultados de forma comprensible y objetiva, logrando que tanto especialistas técnicos como usuarios de distintas áreas entendieran el propósito, el diseño y el funcionamiento de la solución desarrollada.|
|Comunica oralmente sus ideas y/o resultados con objetividad al público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.|<p>**Anyelo Bill Alejos Jesus TB01:**</p><p>Realicé exposiciones internas sobre los avances en la identificación de necesidades de los usuarios, el diseño de entrevistas y la elaboración de perfiles de usuarios. Expliqué con claridad cómo cada apartado contribuye a la solución de problemas reales del mercado agrícola peruano. Ajusté el nivel de tecnicismo y ejemplos utilizados según el público, utilizando lenguaje sencillo para referirme a funcionalidades complejas como trazabilidad de productos, reputación de usuarios o filtros de búsqueda agrícola.</p>|Logré comunicar los objetivos y beneficios de AgroMercado de forma sencilla y efectiva, ayudando a que tanto mi equipo como otros perfiles comprendan cómo nuestra solución mejora la comercialización agrícola.|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.|<p>**Anyelo Bill Alejos Jesus TB01:**</p><p>Participé activamente en el desarrollo de los apartados de Elicitación y Análisis de Requisitos, incluyendo el análisis competitivo de plataformas agrícolas en el mercado peruano, el diseño de entrevistas para productores y compradores, la creación de User Personas representativos del público objetivo, la matriz de tareas (User Task Matrix) y el planteamiento de estrategias y tácticas basadas en el análisis SWOT.</p>|<p>Pude organizar y comunicar la información del proyecto de manera comprensible y concreta, permitiendo que cualquier lector entienda el valor y propósito de AgroMercado.</p><p></p>|
...
<table>
  ...
  <tr>
    ...
    <b>Acerca de:</b>
    <br>
    Hola, soy Joaquin estudiante de ing de software, tengo 20 años y mis intereses tecnicos son la programacion en c, c#, Shell scripts y redes. Espero ser de utilidad para mi grupo y aprender en el camino.
    </td>
  </tr>
  </tr>
...
- Un título claro, un subtítulo contextual, y un párrafo explicativo.
...
## 4.2.3. Metadatos SEO y Metaetiquetas
...
<img  src="Assets/Historico sin registros.png"  alt="Empty history Page Browser"  min-width="400"  max-width="900"/>
...
<img  src="Assets/AgroMercado/Registro de Ventas (Vista vendedor).png"  alt="Transaccion"  min-width="400"  max-width="900"/>
...
Estos valores orientan el diseño de funcionalidades que buscan democratizar el acceso digital al comercio agrícola, especialmente en zonas rurales con bajo nivel de familiaridad tecnológica.
...
- **Publicación de productos:** Creación, edición y eliminación de productos disponibles para la venta.
- **Gestión de pedidos:** Envío, recepción y respuesta a solicitudes de compra.
- **Procesamiento de transacciones:** Confirmación de ventas y compras, incluyendo integración con el sistema de pagos.
- **Calificación entre usuarios:** Evaluación mutua post transacción, fortaleciendo la confianza en la comunidad.
- **Visualización de actividad:** Acceso a resúmenes de compras, ventas, productos activos y métricas clave del usuario.

### Bounded Contexts Identificados

Como resultado del proceso de modelado del dominio, se definieron los siguientes Bounded Contexts, cada uno con una responsabilidad específica dentro del sistema. Estos contextos representan divisiones naturales del dominio, facilitando una arquitectura desacoplada y mantenible:

| **Bounded Context** | **Responsabilidad Principal**                                                                     |
|------------------|-----------------------------------------------------------------------------------------------|
| **Security**         | Registro de usuarios, inicio de sesión, edición de cuenta.                                   |
| **Catalog**          | Publicación, edición y eliminación de productos agrícolas.                                   |
| **Orders**           | Envío y gestión de pedidos realizados por compradores.                                        |
| **Sales**            | Confirmación de compras y ventas, registro de transacciones.                                 |
| **Ratings**          | Calificación entre compradores y vendedores tras la transacción.                             |
| **Notifications**    | Emisión de notificaciones en respuesta a eventos clave.                                      |
| **Dashboard**        | Visualización consolidada de la actividad comercial del usuario.                             |
...
<img  src="Assets/C4 01.png"  alt="C4: 01"  min-width="400"  max-width="900"/>
...
<img  src="Assets/C4 02.png"  alt="C4: 02"  min-width="400"  max-width="900"/>
...
<img  src="Assets/C4 03.png"  alt="C4: 03"  min-width="400"  max-width="900"/>

#### Sales, Order and dashboard Bounded Context

<img  src="Assets/C4 04.png"  alt="C4: 04"  min-width="400"  max-width="900"/>

#### Users Bounded Context

<img  src="Assets/C4 05.png"  alt="C4: 05"  min-width="400"  max-width="900"/>

### 4.7. Software Object-Oriented Design.
### 4.7.1. Class Diagrams.

<img  src="Assets/Class Diagrams.png"  alt="Diagrama de clases"  min-width="400"  max-width="900"/>
...
| contraseña   | string   | Contraseña cifrada para acceder a la plataforma.                     |
| rol          | string   | Rol del usuario (comprador, productor o administrador).              |
| fotoPerfil   | string   | Ruta o URL de la imagen de perfil del usuario.                       |
| direccion    | string   | Dirección física o de contacto del usuario.                          |
...
| ruc        | string | Número de RUC (Registro Único de Contribuyentes) de la empresa.           |

#### Clase: UsuarioEmpresa

| Atributo   | Tipo | Descripción                                              |
|------------|------|----------------------------------------------------------|
| idUsuario  | int  | ID del usuario vinculado a la empresa.                   |
| idEmpresa  | int  | ID de la empresa a la que pertenece el usuario.          |
...
| nombre   | string | Nombre o etiqueta de la categoría.               |
...
| idUsuario        | int      | ID del usuario que publicó el producto.                          |
| idCategoria      | int      | ID de la categoría a la que pertenece el producto.               |
| nombre           | string   | Nombre del producto agrícola.                                    |
| descripcion      | string   | Descripción detallada del producto.                              |
| precio           | float    | Precio por unidad del producto.                                  |
| stock            | int      | Cantidad disponible en inventario.                               |
| ubicacion        | string   | Lugar donde se encuentra disponible el producto.                 |
| fechaPublicacion | datetime | Fecha en que el producto fue publicado.                          |
...
| idProducto    | int      | ID del producto solicitado.                                                 |
| idComprador   | int      | ID del usuario que realizó el pedido.                                       |
| cantidad      | int      | Número de unidades pedidas.                                                 |
| estado        | string   | Estado actual del pedido (pendiente, entregado, cancelado, etc.).           |
| fechaPedido   | datetime | Fecha en que se realizó el pedido.                                          |
| fechaEntrega  | datetime | Fecha de entrega estimada o confirmada.                                     |
...
| Atributo    | Tipo     | Descripción                                                                 |
|-------------|----------|-----------------------------------------------------------------------------|
| id          | int      | Identificador único de la calificación.                                     |
| idEmisor    | int      | ID del usuario que realizó la calificación.                                 |
| idReceptor  | int      | ID del usuario que recibió la calificación.                                 |
| idPedido    | int      | ID del pedido relacionado.                                                  |
| rolEmisor   | string   | Rol del emisor durante la transacción (comprador o vendedor).              |
| puntuacion  | int      | Puntuación otorgada (ej. de 1 a 5).                                         |
| comentario  | string   | Comentario adicional sobre la experiencia.                                  |
| fecha       | datetime | Fecha en la que se registró la calificación.                                |
...
| idUsuario  | int      | ID del usuario destinatario.                                    |
| titulo     | string   | Título breve del mensaje.                                       |
| mensaje    | string   | Contenido de la notificación.                                   |
| leida      | boolean  | Indica si el usuario ya ha leído la notificación.               |
| fecha      | datetime | Fecha y hora en que fue enviada.                                |

#### Clase: Historial

| Atributo    | Tipo     | Descripción                                                               |
|-------------|----------|---------------------------------------------------------------------------|
| id          | int      | Identificador único del evento registrado.                                |
| idUsuario   | int      | ID del usuario que realizó la acción.                                     |
| tipoAccion  | string   | Tipo de acción registrada (ej. login, editar, publicar, etc.).            |
| descripcion | string   | Descripción de la acción realizada.                                       |
| fecha       | datetime | Fecha en la que ocurrió la acción.                                        |
...
| idEmisor     | int      | ID del usuario que envió el mensaje.                               |
| idReceptor   | int      | ID del usuario que recibió el mensaje.                             |
| contenido    | string   | Texto del mensaje enviado.                                         |
| fechaEnvio   | datetime | Fecha en la que fue enviado el mensaje.                            |
...
| idUsuario     | int      | ID del usuario que generó el reporte.                             |
| tipo          | string   | Tipo de reporte generado (ventas, pedidos, productos, etc.).      |
| descripcion   | string   | Descripción del contenido del reporte.                            |
| fechaCreacion | datetime | Fecha en la que se generó el reporte.                             |

### 4.8. Diseño de bases de datos.

Para este proyecto se eligió MySQL como sistema de gestión de bases de datos por su capacidad de adaptarse al crecimiento del sistema y su facilidad de uso. Esta tecnología ofrece una arquitectura flexible que permite incrementar los recursos según evolucionen los requerimientos del negocio. Además, su entorno de trabajo resulta familiar para el equipo, gracias a su similitud operativa con plataformas como Microsoft SQL Server.

### 4.8.1. Diagrama de base de datos.

<img  src="Assets/AgroMercado/Base de datos.png"  alt="Diagrama de clases"  min-width="400"  max-width="900"/>
...
- **Trello:**  Esta plataforma será empleada para el monitoreo del avance del proyecto, permitiendo una gestión clara y visual de las actividades a través de tableros organizados por tareas. Su estructura basada en listas y tarjetas facilita el seguimiento del progreso en cada sprint bajo metodologías ágiles: https://trello.com/es

#### Diseño UX/UI de producto
- **Figma:** Herramienta colaborativa en línea para la creación de diseños interactivos. Dentro del marco del proyecto, se utilizará para desarrollar los prototipos funcionales de la aplicación en sus versiones tanto para navegador de escritorio como para dispositivos móviles: https://www.figma.com/login

- **Lucidchart:** Aplicación de diagramación que será aprovechada para construir flujos visuales como wireflows, mapas de navegación y diagramas de clases, fundamentales para el diseño estructural de la plataforma.: https://www.lucidchart.com/

#### Pruebas de software
- **Gherkin:** Lenguaje de formateo enfocado en la escritura de criterios de aceptación para historias de usuario, facilitando la especificación de comportamientos esperados de forma clara y comprensible para todos los involucrados: https://cucumber.io/docs/gherkin/

#### Software Development
- **Visual Studio Code:** Editor de código fuente seleccionado como entorno de desarrollo principal debido a su compatibilidad con múltiples lenguajes, facilidad de personalización mediante extensiones y disponibilidad multiplataforma. Será el IDE base para la codificación del sistema.. Ruta de referencia https://code.visualstudio.com/

- **HTML5:** Lenguaje de marcado que se utilizará para estructurar y desplegar el contenido de la interfaz de usuario: CSS: Tecnología complementaria al HTML, utilizada para definir la apariencia visual de la aplicación web, controlando estilos, colores, fuentes y distribución de los elementos: https://google.github.io/styleguide/htmlcssguide.html

- **JavaScript:** Lenguaje de programación principal para definir la lógica del lado del cliente, permitiendo crear interfaces dinámicas e interactivas: https://developer.mozilla.org/es/docs/Web/JavaScript

#### Software Deployment
- **Git:** Sistema de control de versiones distribuido que permitirá llevar un registro detallado de los cambios realizados en el código fuente. Se accederá mediante línea de comandos y se integrará con la nube para colaboración del equipo: https://git-scm.com/

### 5.1.2. Source Code Management.
Para la gestión de versiones se adoptará el enfoque propuesto por GitFlow, una estrategia de ramificación popularizada por Vincent Driessen. Este modelo proporciona una estructura clara para el desarrollo colaborativo mediante ramas específicas para funcionalidades, correcciones, pruebas y despliegue.

#### Repositorios GitHub asignados:
- Repositorio general del equipo en GitHub
- Repositorio correspondiente a la Landing Page
- Repositorio asignado a la aplicación web Frontend

Esta metodología permitirá mantener entornos de desarrollo limpios y organizados, facilitando la integración continua y asegurando que las funcionalidades se prueben de forma independiente antes de ser incorporadas a la versión principal del sistema.

#### Estructura de branches (Ramas):
En el desarrollo de AgroMercado, se implementará una estructura de ramificación basada en GitFlow, con el objetivo de mantener un entorno ordenado, predecible y adecuado para trabajo en equipo. A continuación, se describen los tipos de ramas que se utilizarán en el control de versiones:

- **Rama main (producción):**
Servirá como la fuente oficial de versiones estables del proyecto. Únicamente se integrarán cambios que hayan sido evaluados y validados en entornos de prueba. Esta rama será utilizada para desplegar versiones finales.
- **Rama develop (desarrollo):**
Representa el entorno de trabajo donde se consolidarán los aportes funcionales de cada integrante. En esta rama se mantendrá el estado más actualizado del proyecto, incluyendo avances no definitivos.
- **Ramas de características (feature/*):**
Cada nueva funcionalidad será desarrollada en una rama independiente, utilizando una convención de nombres tipo feature/nombre-descriptivo. Una vez completada y revisada, se integrará a la rama de desarrollo.
- **Ramas de versión (release/*):**
Estas ramas derivan de develop cuando se considere que una versión está próxima a su despliegue. Permiten realizar pruebas finales y pequeños ajustes sin afectar el desarrollo continuo. Se nombrarán siguiendo el estándar de versionado semántico (por ejemplo: release/1.0.0).
- **Ramas de correcciones rápidas (hotfix/*):**
Utilizadas para atender fallos críticos detectados en producción. Estas ramas parten de main, permiten corregir el error y luego se fusionan tanto en main como en develop.

#### Versionamiento Semántico:
AgroMercado adoptará el estándar SemVer para asignar números de versión en formato MAJOR.MINOR.PATCH. Este enfoque permite distinguir entre cambios incompatibles, mejoras agregadas de manera retrocompatible y correcciones de errores.

#### Convenciones de Commits:
Se empleará el estilo Conventional Commits, inspirado en la guía de commits de Angular. Este formato ayuda a estandarizar los mensajes y facilita la generación automática de changelogs:
        
    git commit -m "feat[producto]: Descripcion del cambio"

### 5.1.3. Source Code Style Guide & Conventions.

### HTML: 
- Todos los elementos deben cerrarse correctamente (ejemplo:).

      <div></div>
      
- El uso de minúsculas será obligatorio para etiquetas y atributos.
- Los atributos con espacios deben incluirse entre comillas.
- Las imágenes deben tener alt, width y height definidos para mejorar la accesibilidad y rendimiento.

### CSS
- Las clases e IDs deben tener nombres cortos, intuitivos y descriptivos.
- Se utilizará guión medio para separar palabras:

      .boton-primario, #form-contacto.

- No se especificará unidad en valores cero: margin: 0;
- Cada declaración y selector irá en línea separada para mejorar la legibilidad.

### Gherkin (para pruebas funcionales BDD)
- Este lenguaje estructurado se utilizará para redactar los escenarios de prueba bajo el enfoque de Desarrollo Guiado por Comportamiento (BDD).
- Se usarán las palabras clave: Given, When, Then, And, estructurando claramente cada paso.
- Se aplicarán saltos de línea para distinguir claramente entre distintos escenarios, mejorando su comprensión tanto por desarrolladores como por usuarios de negocio.

### 5.1.4. Software Deployment Configuration.
### Landing page deployment:

<img  src="Assets/Deploy landing page.png"  alt="Deploy landing page"  min-width="400"  max-width="900"/>

Enlace para acceder a la [landing page]()
### Front End Web Application deployment
 
Enlace para acceder a [la aplicación web front-end]()
...
| Prepared By                 | Integrantes de Hidrobots                              |
| Attendess (to planning meeting) | Alejos Jesus, Anyelo Bill, Horna Silva, Fabio Ernesto |
Objetivo del Sprint         | El desarrollo y despliegue de la Landing Page, la primera versión de la aplicación web, y un avance del Api REST. |
| Logros                      | Se lograron los objetivos propuestos.                |
| Comunicación                | Se logró mantener una excelente comunicación entre los integrantes del equipo, gracias al uso de plataformas como Discord. |
| Mejoras a implementar       | Mejorar la organización para no estar al límite del deadline y perfeccionar la estimación del desarrollo de user stories. Esto garantizará un flujo de trabajo más estable. |
| Sprint 1 Goal               | Consolidar la funcionalidad inicial de la plataforma, confirmando que la Landing Page esté completamente operativa, la aplicación web accesible con funcionalidad básica y el API REST permita las primeras integraciones clave. |
| Sprint 1 Velocity           | 22 (Sum of Story Points: 20)                          |

#### 5.2.1.2. Aspect Leaders and Collaborators.

| Alumno                      | Actividad                                                              |
|-----------------------------|------------------------------------------------------------------------|
| Fabio Horna Silva           | Implementación del encabezado de sección de la página de destino       |
| Anyelo Bill Alejos Jesus    | Implementación del encabezado de sección de la Is AS Scenario y entrevistas |

#### 5.2.1.3. Sprint Backlog 1.
El Sprint Backlog es una herramienta fundamental dentro del marco de trabajo ágil Scrum. Representa el conjunto de tareas y elementos del Product Backlog que el equipo ha seleccionado para desarrollar durante el sprint actual, con el objetivo de alcanzar un incremento de producto funcional y entregable. Este documento permite visualizar de manera clara qué se va a construir, cómo se va a construir y quién se encargará de cada actividad. A través del Sprint Backlog, se promueve la planificación colaborativa, el enfoque en la entrega de valor y la transparencia en el avance del equipo, a continuación el sprint correspondiente:


# Tareas del Proyecto AgroMercado

| Id  | Title                                 | Task Id | Task Title                             | Description                                                                                          | Estimation (Hours) | Assigned To  | Status |
|--------|-------------------------------------------|---------|-----------------------------------------|------------------------------------------------------------------------------------------------------|---------------------|---------------|--------|
| HU16   | Ver información de AgroMercado            | T01     | Implementar sección “¿Qué es AgroMercado?” | Mostrar contenido claro sobre la plataforma, su propósito y a quién está dirigida                    | 3                   | Fabio Horna   | Done   |
| HU17   | Ver los beneficios de la plataforma       | T02     | Beneficios para compradores y vendedores | Presentar ventajas diferenciadas para cada tipo de usuario dentro de la landing page                | 3                   | Fabio Horna   | Done   |
| HU18   | Acceder al login desde la landing         | T03     | Botón de acceso al login desde landing   | Agregar botón visible y funcional en la landing para redirigir al formulario de inicio de sesión     | 1                   | Fabio Horna   | Done   |
| HU19   | Acceder al registro desde la landing      | T04     | Botón de acceso al registro desde landing| Agregar botón visible en la landing que redirija al formulario de registro                          | 1                   | Fabio Horna   | Done   |
| HU20   | Conocer al equipo detrás del proyecto     | T05     | Sección “Conócenos”                      | Mostrar nombres, fotos y roles de los miembros de AgroMercado para dar confianza al usuario         | 2                   | Fabio Horna   | Done   |
| HU21   | Ver sección de contacto o ayuda rápida    | T06     | Enlace rápido a contacto o ayuda         | Colocar acceso fácil en el footer o header para contactar al equipo o leer preguntas frecuentes      | 2                   | Fabio Horna   | Done   |
| HU01   | Registrarme                               | T07     | Formulario de registro de usuario        | Crear formulario funcional con validación y redirección tras registro exitoso                       | 5                   | Fabio Horna   | To-do  |
| HU02   | Iniciar sesión                            | T08     | Formulario de login                      | Implementar autenticación de usuario mediante correo y contraseña                                   | 4                   | Fabio Horna   | To-do  |
| HU03   | Cerrar sesión                             | T09     | Botón de logout                          | Permitir cerrar sesión de forma segura con redirección a la landing page                            | 1                   | Fabio Horna   | To-do  |

#### 5.2.1.4. Development Evidence for Sprint Review

| Repository       | Branch | Commit ID | Author       | Message | Time ago |
|------------------|--------|-----------|--------------|---------|----------|
| Landing Page     | Main   |           | Fabio_Horna  |         |          |
| Landing Page     | Main   |           | Fabio_Horna  |         |          |
| Web Application  | Main   |           |              |         |          |

#### 5.2.1.5. Execution Evidence for Sprint Review.
En el sprint 1 se alcanzó un desarrollo parcial en la implementación del despliegue del landing page. La cual muestra diferentes secciones donde el usuario puede encontrar información relevante acerca del producto y del startup. A continuación, se muestran algunas evidencias:

<img  src="Assets/Presentacion individual.png"  alt="Presentacion individual page"  min-width="400"  max-width="900"/>

<img  src="Assets/team-members.png"  alt="Team members cards"  min-width="400"  max-width="900"/>

<img  src="Assets/github forum.png"  alt="github forum"  min-width="400"  max-width="900"/>

#### 5.2.1.8. Team Collaboration Insights during Sprint.

# Actividad del Alumno - Sprint
